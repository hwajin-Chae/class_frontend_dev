...
// addEventListener() 메소드: 해당 요소에 지정한 이벤트(Event)가 발생하는 지 듣고(Listen) 있다가
// 실제 이벤트가 발생하면 연결된 함수(콜백)를 실행
...
let hasActive = boxEl.classList.contains('active');  // 요소에 active라는 클래스 속성의 값이 있는지 확인
